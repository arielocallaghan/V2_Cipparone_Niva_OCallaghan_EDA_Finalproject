...
#plot 2019 data
Health.z.2019<-mapview(Health_Data_2019, 
        zcol = 'Health.Factors.Z.Score', 
        col.regions = brewer.pal(10,'BrBG'))

Heath.rank2019<-mapview(Health_Data_2019, 
...
Health.z.2010<-mapview(Health_Data_2010, 
        zcol = 'Health.Factors.Z.Score', 
        col.regions = brewer.pal(9, 'BrBG'))


Heath.rank2010<-mapview(Health_Data_2010, 
        zcol = 'Health.Outcomes.Rank', 
