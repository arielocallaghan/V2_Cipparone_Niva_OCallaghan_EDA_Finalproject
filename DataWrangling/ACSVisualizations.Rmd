...
pa.county.summary<-pa.2019.clean %>% 
  summarize(
    totpop.range= range(totpop),
    medincome.range= range(medincome),
    perc.white.range = range(perc.white),
    perc.bachdegree.range= range(perc.bachdegree),
    totpop.med = median(totpop),
    medincome.med = median(medincome),
    perc.white.med = median(perc.white),
    perc.bachdegree.med = median(perc.bachdegree),
    totpop.iqr = IQR(totpop),
    medincome.iqr = IQR(medincome),
    perc.white.iqr = IQR(perc.white),
    perc.bachdegree.iqr = IQR(perc.bachdegree)
  )
