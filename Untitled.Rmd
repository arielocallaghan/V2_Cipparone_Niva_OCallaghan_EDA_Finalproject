...
```{r Coal-Summary-Table-Code, fig.cap = "Summary Statistics of coal production in Pennsylvania", echo=FALSE}
...
gt() %>% 
  ...
  tab_header(
    title = md("Summary Statistics of County-Level Coal Production Variables in Pennsylvania"), subtitle="   ") %>%
