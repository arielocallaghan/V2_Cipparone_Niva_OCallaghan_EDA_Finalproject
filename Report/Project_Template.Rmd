...
```{r Code for ggplot mapping coal production over time in each county, echo=TRUE, fig.align='left', fig.cap="Coal Production plotted over time at each Pennsylvania County", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Coal Data Exploratory Analysis}
...
###Figure (2019 Z score)
```{r Health 2019 Z score, echo=TRUE, fig.align='left', fig.cap="Shows Z scores of health outcome data by County in 2019", fig.height=2.5, message=FALSE, warning=FALSE}
...
###(Figure XX (2019 Rank)
```{r Figure 2019 Rank Map, echo=TRUE, fig.align='left', fig.cap="Z scores of health outcome data by County in 2019", fig.height=2.5, message=FALSE, warning=FALSE}
...
###2010 z score map
```{r 2010 Z score map, echo=TRUE, fig.align='left', fig.cap="Z scores of health outcome by County in 2010", fig.height=2.5, message=FALSE, warning=FALSE}
...
###2010 rank map
```{r 2010 Rank Map, echo=TRUE, fig.align='left', fig.cap="Health outcomes ranking by county in 2010", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for looking at counties collectively, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of health outcomes and health factors z scores over time across all counties", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for linear regression time series analysis of all counties}
...
```{r code for looking at schuylkill county with plots of coal production over health factors and linear regression, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for looking at schuylkill county with plots of coal production over health outcomes and coal production over health outcomes and linear regression, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for looking at armstrong county with plots of coal production over health factors and linear regressions, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Armstrong county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for looking at armstrong county with plots of coal production over health outcomes and linear regressions, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Armstrong county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Synchronous plot of coal production and health factors z score over time in the Clearfield county, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Synchronous plot of coal production and health outcomes z score over time in the Clearfield county,echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Mixed correlation plot here, echo=TRUE, fig.align='left', fig.cap="Mixed correlation plot for all variables of interest. Blue values are positive and red values are negative. Correlations performed using Pearson’s correlation coefficient.", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
```{r Linear regression model 1 results here, Echo=TRUE, fig.align='left', fig.cap="Initial regression results including all socioeconomic and coal production variables regressed on health outcomes z-score. Adj. R-squared = 0.5189, 14 degrees of freedom.", fig.height=2.5, message=FALSE, warning=FALSE}
...
###(AIC results here)
```{r AIC results here, Echo=TRUE, fig.align='left', fig.cap="Akaike Information Criteria (AIC) stepwise results", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Linear regression model 2 results here, Echo=TRUE, fig.align='left', fig.cap="Second linear regression following AIC value recommendations for reduced overfitting. Adjusted R-squared: 0.7322, 33 degrees of freedom", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r insert residual vs. fitted, scale location, Normal Q-Q, Residuals vs. Leverage plots here, Echo=TRUE, fig.align='left', fig.cap="Plots to examine multiple linear regression assumptions (homoscedasticity, normality)", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
```{r cowplot of explanatory vs response variables here, echo=TRUE, fig.align='left', fig.cap="Plots to examine linearity assumption of multiple linear regression model.", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
