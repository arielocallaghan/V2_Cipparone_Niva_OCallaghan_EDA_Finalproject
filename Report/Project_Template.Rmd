...
\newpage
\listoftables 
-Table 1:Coal Summary Table
-Table 2:Community Health Outcome Summary Table 
...
**Coal Data Exploratory Analysis**
...
```
*********************************************
REMOVED FROM GOOGLE DOCS TEXT-------------DELETE??
...
**Schuykill County**
```{r Code schuylkill County Heath Factors, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Schuylkill County Health Outcomes, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Armstrong Synchronous plot County Health, echo=TRUE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Armstrong county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Mixed correlation plot, echo=TRUE, fig.align='left', fig.cap="Mixed correlation plot for all variables of interest. Blue values are positive and red values are negative. Correlations performed using Pearson’s correlation coefficient.", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
