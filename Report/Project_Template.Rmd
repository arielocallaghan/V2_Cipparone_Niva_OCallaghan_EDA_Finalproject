...
###(Figure XX (2019 Rank)
```{r Figure 2019 Rank, echo=TRUE, fig.align='left', fig.cap="Shows Z scores of health outcome data by County in 2019", fig.height=, message=FALSE, warning=FALSE}
