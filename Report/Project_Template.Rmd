...
#random action just to test things
x<-1
...
```{r Mixed correlation plot here, echo=TRUE, fig.align='left', fig.cap="Mixed correlation plot for all variables of interest. Blue values are positive and red values are negative. Correlations performed using Pearson’s correlation coefficient.", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r insert residual vs. fitted, scale location, Normal Q-Q, Residuals vs. Leverage plots here, Echo=TRUE, fig.align='left', fig.cap="Plots to examine multiple linear regression assumptions (homoscedasticity, normality)", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r cowplot of explanatory vs response variables here, echo=TRUE, fig.align='left', fig.cap="Plots to examine linearity assumption of multiple linear regression model.", fig.height=2.5, message=FALSE, warning=FALSE}
...
#Water Quality Data Here (should this be a cowplot? Then only need for one caption)
```{r insert cowplot of explanatory vs response variables here, echo=TRUE, fig.cap="Plots to examine linearity assumption of multiple linear regression model.", fig.height=2.5, message=FALSE, warning=FALSE}

#(Code with water quality data wrangling and a graph showing high sulfate concentrations and 3 graphs with the correlation between sulfate levels and other metals)
#FIgure Caption: Sulfate Concentrations observed in mine runoff within pennsylvania over time
#Figure Caption: Sulfate Concentrations plotted against Calcium concentrations within Pennsylvania
#Figure Caption: Sulfate Concentrations plotted against Magnesium concentrations within Pennsylvania
#Figure Caption: Sulfate Concentrations plotted against Sodium concentrations within Pennsylvania
