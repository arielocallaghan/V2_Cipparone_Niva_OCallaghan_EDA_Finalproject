...
```{r Coal-Summary-Table, fig.cap = "Summary Statistics of coal production in Pennsylvania", echo=FALSE}

#We can make the summary table of the data within the dataset

coal.data.summary <- aggCoalSlim2 %>% 
    rename("Coal Production per Year" = coal.prod.by.year, "Weighted Year of Peak Production" = year.peak.prod, "Total Coal Produced" = sum.coal.prod) %>% 
...
```{r Spatial Data Code Wrangling, message=FALSE, warning=FALSE, include=FALSE}
...
```{r Health-Outcomes-Table, fig.cap="Descriptive statistics for health outcomes", echo=FALSE, message=FALSE, warning=FALSE}
...
#kable(healthdf.table.Z, caption = " ")
```
...
```{r Coal-prod-over-time, echo=FALSE, fig.align='left', fig.cap="Coal Production plotted over time at each Pennsylvania County", fig.height=10, fig.width=20, message=FALSE, warning=FALSE}
...
```{r Health 2019 Z score, fig.align='left', fig.cap="Map of Z scores Health Outcome by County in 2019.", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Figure 2019 Rank Map, fig.align='left', fig.cap="Map of Health Outcome Ranks by County in 2019", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r 2010 Z score map, fig.align='left', fig.cap="Map of Z scores Health Outcome by County in 2010", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r 2010 Rank Map, fig.align='left', fig.cap="Map of Health outcomes ranking by county in 2010", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r dem-counties-graph, fig.align='left', fig.cap="Graph depicting median age, median income, total population, percent of population with a bachelor’s degree and percent of population which is white-identifying for Pennsylvania counties in 2019. Data sourced from ACS 1-year estimates.", fig.height=10, fig.width=20,message=FALSE, warning=FALSE}
...
```{r time-z-all-counties, echo=FALSE, fig.align='left', fig.cap="Synchronous plot of health outcomes and health factors z scores over time across all counties", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r sum-coal-over-time, echo=FALSE, fig.align='left', fig.cap="Plot of coal production over time across all counties", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r code for linear regression time series analysis of all counties factor, message=FALSE, warning=FALSE}
...
```{r code for linear regression time series analysis of all counties outcome, message=FALSE, warning=FALSE}
...
**Schuykill County**
```{r schuylkill-health-factors, echo=FALSE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Schuylkill County Health Factors regression, echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health factors z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r schuylkill-health-outcomes, echo=FALSE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Schuylkill County Health Outcomes regression, echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health outcomes z score over time in the Schuylkill county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Armstrong County Synchronous regression Health Factors, echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health factors z score over time in the Armstrong county", fig.height=2.5, message=FALSE, warning=FALSE}
#linear regression for health factors z score and coal production
...
```{r Code Armstrong Synchronous regression County Health Outcomes, echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health outcomes z score over time in the Armstrong county", fig.height=2.5, message=FALSE, warning=FALSE}
#linear regression for health outcomes z score and coal production
...
**Clearfield County**
```{r clearfield-health-factors, echo=FALSE, fig.align='left', fig.cap="Synchronous plot of coal production and health factors z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Clearfield county Synchronous regression Health Factors, echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health factors z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
#linear regression for health factors z score and coal production
...
```{r clearfield-health-outcomes,echo=FALSE, fig.align='left', fig.cap="Synchronous plot of coal production and health outcomes z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Code Clearfield County Synchronous regression Health Outcomes,echo=FALSE, fig.align='left', fig.cap="Regression of coal production and health outcomes z score over time in the Clearfield county", fig.height=2.5, message=FALSE, warning=FALSE}
#linear regression for health outcomes z score and coal production
...
```{r Mixed-correlation-plot, echo=FALSE, fig.align='left', fig.cap="Mixed correlation plot for all variables of interest. Blue values are positive and red values are negative. Correlations performed using Pearson’s correlation coefficient.", fig.height=10, fig.width=20, message=FALSE, warning=FALSE}
...
```{r Linear regression model 1 results, Echo=FALSE, fig.align='left', fig.cap="Initial regression results including all socioeconomic and coal production variables regressed on health outcomes z-score. Adj. R-squared = 0.5189, 14 degrees of freedom.", fig.height=2.5, message=FALSE, warning=FALSE}
...
**AIC Results**
```{r AIC results, Echo=FALSE, fig.align='left', fig.cap="Akaike Information Criteria (AIC) stepwise results", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r Linear regression model 2 results, Echo=FALSE, fig.align='left', fig.cap="Second linear regression following AIC value recommendations for reduced overfitting. Adjusted R-squared: 0.7322, 33 degrees of freedom", fig.height=2.5, message=FALSE, warning=FALSE}
...
```{r mlr-scatter, echo=FALSE, fig.align='left', fig.cap="Plots to examine linearity assumption of multiple linear regression model.", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
```{r sulfate-plot, echo=FALSE, fig.cap="SO4 Levels Seen in Acid Mine Drainage in Pennsylvania", fig.height=7, message=FALSE, warning=FALSE}
Only.Sulfate <- filter(WaterQualitySlim, Contaminant == "Sulfate as SO4")
