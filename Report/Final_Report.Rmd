...
```{r Spatial Data Code Wrangling, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r ACS-Summary-Table, echo=TRUE, fig.align='left', fig.cap="Summary table of county-level explanatory socioeconomic variables in Pennsylvania. Data from ACS 1-year estimates.", fig.height=, message=FALSE, warning=FALSE}
...
```{r dem-counties-graph, echo=TRUE, fig.align='left', fig.cap="Graph depicting median age, fig.width=20, message=FALSE, warning=FALSE, median income, total population, percent of population with a bachelor’s degree and percent of population which is white-identifying for Pennsylvania counties in 2019. Data sourced from ACS 1-year estimates.", fig.height=10}
